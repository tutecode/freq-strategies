    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                (qtpylib.crossed_below(dataframe['close_1d'], dataframe['senkou_b_1d'])) &
                (dataframe['close_1d'] < dataframe['senkou_a_1d']) &
                (dataframe['close_1d'] < dataframe['senkou_b_1d'])
            ),
            'sell'] = 1
        ...
        dataframe.loc[
            (
                # (qtpylib.crossed_below(dataframe['tenkan_1d'], dataframe['kijun_1d']))
                (qtpylib.crossed_below(dataframe['close_1d'], dataframe['senkou_a_1d'])) &
                (dataframe['close_1d'] < dataframe['senkou_a_1d']) &
                (dataframe['close_1d'] < dataframe['senkou_b_1d'])
            ),
            'sell'] = 1
        ...
        dataframe.loc[
            (
                (dataframe['CDLEVENINGDOJISTAR_1d'] != 0)
            ),
            'sell'] = 1
